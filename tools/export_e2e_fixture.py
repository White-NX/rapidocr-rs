...
def default_cases() -> list[E2eCase]:
    return [
        ...
        E2eCase(
            ...
            full_pipeline(True),
            {"min_exact_text_ratio": 0.0, "min_char_accuracy": 0.8, "max_mean_score_delta": 0.11},
        ),
        E2eCase(
            "ta_no_cls",
            Path("python/tests/test_files/ta.png"),
        ...
        E2eCase(
            "test_letterbox_like_cls",
            Path("python/tests/test_files/test_letterbox_like.jpg"),
            full_pipeline(True),
            {"min_exact_text_ratio": 0.0, "min_char_accuracy": 0.98},
        ),
        E2eCase(
            "test_letterbox_like_no_cls",
            Path("python/tests/test_files/test_letterbox_like.jpg"),
            full_pipeline(False),
            {"min_exact_text_ratio": 0.0, "min_char_accuracy": 0.98},
        ),
        ...
        E2eCase(
            "white_font_color_transparent_det_only",
        ...
        E2eCase("ch_doc_server_no_cls", Path("python/tests/test_files/ch_doc_server.png"), full_pipeline(False)),
        ...
        E2eCase("en_rec_det_only", Path("python/tests/test_files/en_rec.jpg"), det_only_pipeline()),
        ...
        E2eCase("el_rec_det_only", Path("python/tests/test_files/el_rec.jpg"), det_only_pipeline()),
        E2eCase("el_rec_rec_only_cls", Path("python/tests/test_files/el_rec.jpg"), rec_only_pipeline(True)),
        E2eCase("el_rec_rec_only_no_cls", Path("python/tests/test_files/el_rec.jpg"), rec_only_pipeline(False)),
        E2eCase("devanagari_rec_det_only", Path("python/tests/test_files/devanagari_rec.png"), det_only_pipeline()),
        E2eCase("devanagari_rec_rec_only_cls", Path("python/tests/test_files/devanagari_rec.png"), rec_only_pipeline(True)),
        E2eCase("devanagari_rec_rec_only_no_cls", Path("python/tests/test_files/devanagari_rec.png"), rec_only_pipeline(False)),
        E2eCase("th_rec_rec_only_cls", Path("python/tests/test_files/th_rec.jpg"), rec_only_pipeline(True)),
        E2eCase("th_rec_rec_only_no_cls", Path("python/tests/test_files/th_rec.jpg"), rec_only_pipeline(False)),

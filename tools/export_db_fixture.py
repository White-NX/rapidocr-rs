...
def main() -> None:
    ...
    images = args.image or [
        ...
        Path("python/tests/test_files/en_rec.jpg"),
        Path("python/tests/test_files/el_rec.jpg"),
        Path("python/tests/test_files/devanagari_rec.png"),
        ...
        Path("python/tests/test_files/cyrillic.png"),
